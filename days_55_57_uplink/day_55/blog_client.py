...
#
#     @uplink.get('/api/blog')
#     def get_all_entries(self) -> requests.models.Response:
#         """Gets all blog entries from the server"""
#
#     @uplink.get('/api/blog/{entry_id}')
#     def get_entry_by_id(self, entry_id) -> requests.models.Response:
#         """Gets a specific entry by the id"""
#
...
# Mine stopped working so this is the example
